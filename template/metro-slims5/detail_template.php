...
?>
	...
	<div  class="nduwur"><a class="back" href="javascript: history.back();"><img src="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/images/back.png" alt="" width="40" height="40"></a>
