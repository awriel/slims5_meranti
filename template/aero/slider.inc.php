<div class="container">
    <div id="content-slider">
    	<div id="slider">
		<div class="titleNews">New Books</div>
        	<div id="mask">
            <ul>
		...
		<ul>
		    ...
		    <a href="https://www.facebook.com/mas.ido" target="blank"><li><img src="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/images/patung_knalpot.png"><span class="titleLink Link3">'ido alit'</span></li></a>
		</ul>
	    </div>
	    <!-- OTHER LINK -->
        </div>
