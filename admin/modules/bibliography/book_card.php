...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
	...
	foreach ($chunked_book_card_arrays as $bookcard_rows) {
		...
		foreach ($bookcard_rows as $bookcard) {
			$html_str .= '<td valign="top">'."\n";
				...
				if ($bookcard_include_header_text) { $html_str .= '<div class="libname">'.($bookcard_header_text?$bookcard_header_text:$sysconf['library_name']).'<br />Jalan Raya Pucang No. 132, Banjarnegara</div>'."\n";}
				...
				$html_str .= '<td valign="top" style="margin: 0; text-align: center; width: 2.3cm;">Nama</td>'."\n";
				$html_str .= '<td valign="top" style="margin: 0; text-align: center; width: 2cm;">Tgl. Kbl</td>'."\n";
				$html_str .= '<td valign="top" style="margin: 0; text-align: center; width: 0.7cm;">No.</td>'."\n";
				$html_str .= '<td valign="top" style="margin: 0; text-align: center; width: 2.3cm;">Nama</td>'."\n";
				$html_str .= '<td valign="top" style="margin: 0; text-align: center; width: 2cm;">Tgl. Kbl</td>'."\n";
				$html_str .= '</tr>'."\n";
				...
				$html_str .= '<td valign="top" style="margin: 0; text-align: center; width: 2.3cm;">&nbsp;</td>'."\n";
				$html_str .= '<td valign="top" style="margin: 0; text-align: center; width: 2cm;">&nbsp;</td>'."\n";
				$html_str .= '<td valign="top" style="margin: 0; text-align: center; width: 0.7cm;">&nbsp;</td>'."\n";
				$html_str .= '<td valign="top" style="margin: 0; text-align: center; width: 2.3cm;">&nbsp;</td>'."\n";
				$html_str .= '<td valign="top" style="margin: 0; text-align: center; width: 2cm;">&nbsp;</td>'."\n";
				$html_str .= '</tr>'."\n";
	...
	} else { utility::jsAlert('ERROR! Item bookcards failed to generate, possibly because '.SENAYAN_BASE_DIR.FILES_DIR.' directory is not writable'); }
	exit();
}
...
<div class="menuBoxInner printIcon">
	...
	<div class="sub_section">
	   ...
	   <a target="blindSubmit" href="<?php echo MODULES_WEB_ROOT_DIR; ?>bibliography/book_card.php?action=clear" class="notAJAX headerText2" style="color: #f00;"><?php echo __('Clear Print Queue'); ?></a>
	   <a target="blindSubmit" href="<?php echo MODULES_WEB_ROOT_DIR; ?>bibliography/book_card.php?action=print" class="notAJAX headerText2"><?php echo __('Print Book Card for Selected Data');?></a>
		</div>
	  <form name="search" action="<?php echo MODULES_WEB_ROOT_DIR; ?>bibliography/book_card.php" id="search" method="get" style="display: inline;"><?php echo __('Search'); ?> :
