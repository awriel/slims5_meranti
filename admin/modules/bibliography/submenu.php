...
$menu[] = array(__('Labels Barcodes Printing'), MODULES_WEB_ROOT_DIR.'bibliography/label_barcode_generator.php', __('Print Label with Item Barcodes'));
$menu[] = array(__('Book Card Printing'), MODULES_WEB_ROOT_DIR.'bibliography/book_card.php', __('Book Card Printing'));
$menu[] = array(__('Book Return Slip Printing'), MODULES_WEB_ROOT_DIR.'bibliography/book_return_slip.php', __('Book Return Slip Printing'));
